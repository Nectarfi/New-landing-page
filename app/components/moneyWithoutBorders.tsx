  ...
  return (
    <section className="relative w-full px-4 sm:px-6 lg:px-8 py-10 bg-black rounded-3xl text-white overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img src="/images/background-pattern.png" alt="Background Pattern" className="w-full h-full object-cover opacity-30" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-row justify-between w-full gap-12 items-center">
          <div className="space-y-8 lg:w-[35%]">
            ...
            <button className="bg-white text-gray-800 px-8 py-4 rounded-2xl text-sm font-semibold hover:bg-gray-200 transition-colors duration-300 shadow-lg">
              Learn more
            </button>
          </div>
